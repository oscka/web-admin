package com.osckorea.openmsa.admin.repository.raw.feign;
...
@FeignClient(name = "NEXUS-RAW-REPOSITORY-PUBLIC-CLIENT", url = "${api.nexus.public}/repositories/raw", configuration = {NexusFeignClientConfiguration.class})
