package com.osckorea.openmsa.admin.repository.nuget.feign;
...
@FeignClient(name = "NEXUS-NUGET-REPOSITORY-PUBLIC-CLIENT", url = "${api.nexus.public}/repositories/nuget", configuration = {NexusFeignClientConfiguration.class})
