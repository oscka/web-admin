package com.osckorea.openmsa.nexus.repository.pypi.feign;
...
@FeignClient(name = "NEXUS-PYPI-REPOSITORY-PUBLIC-CLIENT", url = "${api.nexus.public}/repositories/pypi", configuration = {NexusApiFeignClientConfiguration.class})
