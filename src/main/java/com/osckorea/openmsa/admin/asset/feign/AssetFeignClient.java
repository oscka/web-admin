package com.osckorea.openmsa.admin.asset.feign;
...
@FeignClient(name = "NEXUS-ASSET-PUBLIC-CLIENT", url = "${api.nexus.public}/assets", configuration = {NexusFeignClientConfiguration.class})
