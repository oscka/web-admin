package com.osckorea.openmsa.nexus.repository.maven.feign;
...
import com.osckorea.openmsa.nexus.repository.maven.dto.MavenGroupDto;
import com.osckorea.openmsa.nexus.repository.maven.dto.MavenHostedDto;
import com.osckorea.openmsa.nexus.repository.maven.dto.MavenProxyDto;
import com.osckorea.openmsa.nexus.common.config.NexusApiFeignClientConfiguration;

@FeignClient(name = "NEXUS-MAVEN-REPOSITORY-PUBLIC-CLIENT", url = "${api.nexus.public}/repositories/maven", configuration = {NexusApiFeignClientConfiguration.class})
