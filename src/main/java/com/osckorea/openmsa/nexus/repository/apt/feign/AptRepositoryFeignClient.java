package com.osckorea.openmsa.nexus.repository.apt.feign;
...
@FeignClient(name = "NEXUS-APT-REPOSITORY-PUBLIC-CLIENT", url = "${api.nexus.public}/repositories/apt", configuration = {NexusApiFeignClientConfiguration.class})
