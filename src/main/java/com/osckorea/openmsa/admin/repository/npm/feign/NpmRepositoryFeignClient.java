package com.osckorea.openmsa.admin.repository.npm.feign;
...
@FeignClient(name = "NEXUS-NPM-REPOSITORY-PUBLIC-CLIENT", url = "${api.nexus.public}/repositories/npm", configuration = {NexusFeignClientConfiguration.class})
